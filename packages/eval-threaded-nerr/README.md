...
Internal shexjs regular expression library for [`@shexjs/validator`](../shex-validator#readme).

This evaluator exhaustively enumerate combinations of ways the data fails to satisfy a shape's expression.


## install

``` shell
npm install --save @shexjs/eval-threaded-nerr
```
