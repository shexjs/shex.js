...
function dispatchWasm(exports, code, triple) {
    ...
    if (status === Statuses.PASS || status === Statuses.FAIL)
        ...
        line = new TextDecoder().decode(new Uint8Array(exports.memory.buffer, exports.linePtr.value, exports.lineLen.value));
...
//# sourceMappingURL=shex-extension-wasi-test.js.map