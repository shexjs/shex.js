    ...
    run() {
        ...
        while (!this.dbg.done) {
            ...
            switch (cmd) {
                case "": break;
                case "s":
                    this.showEvent(this.dbg.stepInto());
                    break;
                case "n":
                    this.showEvent(this.dbg.stepOver());
                    break;
                case "o":
                    this.showEvent(this.dbg.stepOut());
                    break;
                case "c":
                    this.showEvent(this.dbg.continue());
                    break;
                case "b":
                    this.setPositionBreakpoint(args[0]);
                    break;
                case "bp":
                    this.setPredicateBreakpoint(args[0]);
                    break;
                case "bn":
                    this.setNodeBreakpoint(args[0]);
                    break;
                case "t":
                ...
                case "info":
                    ...
                    break;
                case "l":
                    this.showEvent(this.dbg.current, true);
                    break;
                case "h":
