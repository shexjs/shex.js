 ...
 */
function applyPrefix(varName: string, prefixes: { [prefix: string]: string }): string {
 ...
 */
function buildExpandedVars(shortPrefixedVar: string, expandedVars: string[], prefixes: { [prefix: string]: string }): string {
 ...
 */
function trimPattern(mapDirective: string, args: string): string {
    if (/^\s*\/.*\/\s*$/.test(args)) {
...
function lift(mapDirective: string, input: any, prefixes: { [prefix: string]: string }, args: string) {
...
function lower(mapDirective: string, bindings: any, prefixes: { [prefix: string]: string }, args: string) {
    args = trimPattern(mapDirective, args);
