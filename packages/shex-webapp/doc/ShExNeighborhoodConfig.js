 ...
 * fields, slurping.
 *
 * This is doc/ShExNeighborhoodConfig.js's source (tsconfig.app.json compiles src/app/ into
...
class NeighborhoodConfig {
    ...
    docAt(n) {
        ...
        if (n < 0 || n >= docs.length)
            return null;
        const doc = docs[n];
        return Object.assign({}, doc, n === this.showing && !this.onSettings
    ...
    addPane(text) {
        ...
        const at = this.documents().findIndex(d => d.param.name === spec.name && d.index === texts.length - 1);
