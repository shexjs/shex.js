...
class ShExBaseApp {
    ...
    constructor(base) {
        ...
        this.neighborhoods = new NeighborhoodConfig(ShExWebApp.NeighborhoodModules, inputData.selection, changed => {
        ...
        this.QueryParams = this.Getables.concat([
            ...
            { queryStringParm: "explain", location: $("#explain"), deflt: "both",
                ...
                normalize: (v) => /^(repairs|errors)$/.test(v) ? v : "both" },
    ...
    navigateManifestKeyDown(e, code) {
        ...
        function navFrom(keyCode, fromLi) {
            ...
            const columns = $('ul[data-navColumn]:visible').get().sort((l, r) => parseInt($(l).attr('data-navColumn')) - parseInt($(r).attr('data-navColumn')));
        ...
        function firstOf(node, ...selectors) {
