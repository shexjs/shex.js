...
ShExWriter.prototype = {
  ...
  _writeShape: function (shape, done, forceBraces) {
    ...
    try {
      ...
      function _annotations (annotations, indent) {
        if (annotations) {
      ...
      function _writeExpression (expr, indent, parentPrecedence) {
        function _writeScopedShapeExpression (scopedShapeExpr) {
          if (scopedShapeExpr) {
            pieces.push(" WITH SHAPE EXPRESSION\n");
        ...
        if (expr.type === "TripleConstraint") {
          ...
          _writeScopedShapeExpression(expr.scopedShapeExpression);
          _annotations(expr.annotations, indent);
      ...
      _annotations(shape.annotations, "  ");
