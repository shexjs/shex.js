...
case 18:
 // t: 1val1vsMinusiri3
        if (Parser.valueClasses === null || Parser.valueClasses === undefined)
          Parser.valueClasses = {  };
        Parser.valueClasses[$$[$0-4]] = { type: "valueClassDefn", "value": $$[$0-2] }; // !!! valueExpr:
...
break;
case 20:
this.$ = $$[$0].length > 0 ? { type: "vcand", valueClasses: [$$[$0-1]].concat($$[$0]) } : $$[$0-1];
break;
case 21:
this.$ = $$[$0];
break;
...
case 75:
        ...
        // $$[$0]: t: 1dotCode1
        this.$ = extend({ type: "tripleConstraint", predicate: $$[$0-4]}, { value: $$[$0-3] }, $$[$0-2], $$[$0]); // t: 1dot
        if ($$[$0-1].length)
...
break;
case 86:
this.$ = { type: "vcref", valueClassRef: $$[$0] } // t: 1val1vsMinusiri3;
break;
case 87:
