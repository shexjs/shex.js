...
function LoadPromise (shex, json, turtle, jsonld) {
  ...
  return Promise.all([].
                     ...
                     concat(loadList(shex, function (text, url) {
                       returns.schemaSources.push({mediaType: "text/shex", url: url});
                       return new Promise(function (resolve, reject) {
                         parseShExC(resolve, reject, text, "text/shex", url, returns.schema);
                       });
                     })).
                     concat(loadList(json, function (text, url) {
                       returns.schemaSources.push({mediaType: "text/json", url: url});
                       return new Promise(function (resolve, reject) {
                         parseShExJ(resolve, reject, text, "text/json", url, returns.schema);
                       });
                     })).
                     concat(loadList(turtle, function (text, url) {
                       returns.dataSources.push({mediaType: "text/turtle", url: url});
                       return new Promise(function (resolve, reject) {
                         parseTurtle(resolve, reject, text, "text/turtle", url, returns.data);
                       });
                     })).
                     concat(loadList(jsonld, function (text, url) {
                       returns.dataSources.push({mediaType: "application/ld+json", url: url});
                       return new Promise(function (resolve, reject) {
                         parseJSONLD(resolve, reject, text, "application/ld+json", url, returns.data);
                       });
                     }))
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined')
  module.exports = { load: LoadPromise, loadExtensions: LoadExtensions, loadJSON: LoadJSON }; // node environment
else
