      ...
      new Promise(function (fulfill, reject) {
        ...
        FS.readFile(filename, "utf8", function (error, text) {
          if (error) {
            ...
            fulfill(cb(text, m ? f : "file://" + Path.join(process.cwd(), f)));
          }
        })
      });
  });
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined')
  module.exports = { load: LoadPromise, loadExtensions: LoadExtensions }; // node environment
else
