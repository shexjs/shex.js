...
["Schema", "@context", "startActs", "start", "shapes",
 ...
 "Inclusion", "include",
 "IRIStem", "LiteralStem", "stem",
 "IRIStemRange", "LiteralStemRange", "exclusion",
    ...
    var r = {
      ...
      visitStemRange: function (t) {
        ...
        // _ShExUtil._expect(t, "type", "IRIStemRange");
              ...
              var stemRangeTypes = ["IRIStemRange", "LiteralStemRange"];
      ...
      visitExclusion: function (c) {
        if (!isTerm(c)) {
          // _ShExUtil._expect(c, "type", "IRIStem");
                    ...
                    var stemTypes = ["IRIStem", "LiteralStem"];
  ...
  valuesToSchema: function (values) {
    ...
    function objectValue (v) {
      if ("nested" in v) {
        ...
        if ([SX.IRIStem, SX.LiteralStem].indexOf(t) !== -1) {
        ...
        } else if ([SX.IRIStemRange, SX.LiteralStemRange].indexOf(t) !== -1) {
