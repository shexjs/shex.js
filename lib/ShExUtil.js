...
var ShExUtil = {
  ...
  errsToSimple: function (val, node, shape) {
    ...
    if (val.type === "FailureList") {
      ...
      return ["validating " + n3ify(val.triple.object) + ":"].concat(val.errors.reduce((ret, e) => {
      ...
      var txt;
      w.end((err, res) => { console.log(res); txt = res; });
...
function n3ify (ldterm) {
  ...
  parsePassedNode: function (passedValue, meta, deflt, known) {
