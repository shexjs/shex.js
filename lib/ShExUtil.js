...
var ShExUtil = {
  ...
  Visitor: function () {
    ...
    var r = {
      visitSchema: function (schema) {
        ...
        this._maybeSet(schema, ret, "schema",
                       ["prefixes", "valueExprDefns", "startActs", "start", "shapes"]);
        return ret;
      },
      ...
      // _visitValueGroup: visit a grouping expression (vcand, vcor)
      ...
      visitValueExpr: function (expr) {
        var r = expr.type === 'valueClass' ? this.visitValueClass(expr) :
          ...
          expr.type === 'vcor' ? this.visitVcor(expr) :
    ...
    r.visitVcand = r.visitVcor = r._visitValueGroup;
   ...
   */
  partition: function (schema, includes, deps, cantFind) { debugger;
