    ...
    var r = {
      ...
      visitValues: function (values) {
        ...
        return values.map(function (t) {
          return typeof t === "object" && !("value" in t) ? _Visitor.visitIRIStemRange(t) : t;
        });
      },

      visitIRIStemRange: function (t) {
        var _Visitor = this;
        _ShExUtil._expect(t, "type", "IRIStemRange");
        var stem;
        if (typeof t.stem === "object") {
          _ShExUtil._expect(t.stem, "type", "Wildcard");
          stem = { type: "IRIStemRange", stem: { type: "Wildcard" } };
        } else {
          stem = { type: "IRIStemRange", stem: t.stem };
        }
        if (t.exclusions) {
      ...
      visitExclusion: function (c) {
        if (typeof c === "object") {
          ...
          return { type: "IRIStem", stem: c.stem };
        } else {
          return c;
        }
      },
