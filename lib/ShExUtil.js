...
var ShExUtil = {
  ...
  Visitor: function () {
    ...
    var r = {
      ...
      visitShapeExpr: function (expr, label) {if (expr.type === "ShapeRef") debugger;
        var r =
  ...
  validateSchema: function (schema) { // obselete, but may need other validations in the future.
    ...
    visitor.visitShapeRef = function (shapeRef) { debugger;
