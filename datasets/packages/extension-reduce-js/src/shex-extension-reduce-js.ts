...
class Refusal extends Error {
  readonly value: {failure: any, cut?: boolean};
  constructor (why: any, cut: boolean) {
    const said = why !== null && typeof why === 'object' && 'failure' in why
          ? (why as {failure: any}).failure : why;
    ...
    const value = why !== null && typeof why === 'object' && 'failure' in why
          ? Object.assign({}, why as {failure: any}) : {failure: why};
...
function namesFor (scope: ReduceScope): {[name: string]: any} {
  ...
  return Object.assign({}, scope.api, {
    ...
    reject: (why?: any) => { throw new Refusal(why, false); },
    cut: (why?: any) => { throw new Refusal(why, true); },
