...
const ShExReduce = {
    ...
    schema(schema, app) {
        ...
        this.validated = ShExWebApp.SemActOverlay.applyOverlay(schema, overlay, { prefixes: schema._prefixes || {} });
    ...
    link(app, provenance, ranges, text) {
        ...
        const links = provenance.map(made => {
            ...
            return Object.assign({ panes, status: "conformant" }, made.kind === "shape"
    ...
    methods: {
        ...
        reduce() {
            ...
            let asts;
            try {
                asts = ShExWebApp.Reduce.reduce(ext.parsed, { provenance, schema: ext.validated, onError: e => ext.threw(e, this) });
            }
            catch (e) {
            ...
            const { text, ranges } = ShExWebApp.EditorServices.stringifyWithOffsets(asts.length === 1 ? asts[0] : asts, o => o !== null && typeof o === "object");
