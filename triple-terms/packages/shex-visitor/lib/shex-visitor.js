...
class ShExVisitor {
    ...
    visitSchema(schema, ...args) {
        ...
        this._maybeSet(schema, ret, "Schema", ["@context", "prefixes", "base", "imports", "startActs", "start", "shapes"], ["_base", "_prefixes", "_index", "_sourceMap", "_locations", "_exprLocations"], ...args);
        return ret;
    }
    ...
    visitShapeExpr(expr, ...args) {
        ...
        switch (expr.type) {
            ...
            case "TripleTermConstraint": return this.visitTripleTermConstraint(expr, ...args);
            default:
    ...
    // predicate an IRI
    visitTripleTermConstraint(expr, ...args) {
        return this._maybeSet(expr, { type: "TripleTermConstraint" }, "TripleTermConstraint", ["subject", "predicate", "object"], null, ...args);
    }
    visitSubject(expr, ...args) { return this.visitShapeExpr(expr, ...args); }
    visitObject(expr, ...args) { return this.visitShapeExpr(expr, ...args); }
    ...
    visitTripleConstraint(expr, ...args) {
        ...
        // pre-declare an id so it sorts to the top
        "id" in expr ? { id: null } : {}, { type: "TripleConstraint" }), "TripleConstraint", ["id", "inverse", "predicate", "graph", "valueExpr",
