...
# lezer-shexc: the editor's ShExC grammar (generated by @lezer/generator)
packages/lezer-shexc/src/parser.js: packages/lezer-shexc/src/shexc.grammar packages/lezer-shexc/package.json
	(cd packages/lezer-shexc && npm run build)

# @shexjs/editor-services
packages/shex-editor-services/lib/editor-services.js: packages/lezer-shexc/src/parser.js packages/shex-editor-services/src/editor-services.ts packages/shex-editor-services/src/editor-panes.ts packages/shex-editor-services/package.json packages/shex-editor-services/tsconfig.json
