...
# @shexjs/language-server (LSP server built on editor-services)
packages/shex-language-server/lib/server.js: packages/shex-language-server/src/server.ts packages/shex-language-server/src/validate.ts packages/shex-language-server/src/manifest.ts packages/shex-language-server/src/untyped-modules.d.ts packages/shex-editor-services/lib/editor-services.js packages/shex-validator/lib/shex-validator.js packages/neighborhood-rdfjs/lib/neighborhood-rdfjs.js packages/shex-language-server/package.json packages/shex-language-server/tsconfig.json
	(cd packages/shex-language-server && npm run build)

# shex-vscode (the VS Code client extension; private, packaged with vsce)
packages/shex-vscode/lib/extension.js: packages/shex-vscode/src/extension.ts packages/shex-vscode/package.json packages/shex-vscode/tsconfig.json
	(cd packages/shex-vscode && npm run build)
