...
exports.construct = exports.ShExCParserState = void 0;
const ShExJisonParser = require('./ShExJison').ShExJisonParser;
const schemeAuthority = /^(?:([a-z][a-z0-9+.-]*:))?(?:\/\/[^\/]*)?/i, dotSegments = /(?:^|\/)\.\.?(?:$|[\/#?])/;
class ShExCParserState {
    ...
    addTemplate(label, template, start, end) {
...
exports.ShExCParserState = ShExCParserState;
...
const prepareParser = function (baseIRI, prefixes, schemaOptions) {
    ...
    function runParser(input, base = baseIRI, options = schemaOptions, _filename = null) {
        ...
        let errors = [];
        parserState.recoverable = e => errors.push(e);
        let ret = null;
        try {
    ...
    return parser;
    function contextError(e, _lexer) {
...
exports.construct = prepareParser;
