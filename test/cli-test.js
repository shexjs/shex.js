...
var AllTests = {
  ...
  "rdf-to-json": [
    ...
    { name: "rdf-file", args: ["--rdffile", "Map/CMUMPS-FHIR/demographics.ttl"], resultMatch: '"http://hokukahu.com/patient-1"', status: 0 },

    { name: "rdf-file-media", args: ["--rdffile", "Map/CMUMPS-FHIR/demographics.ttl", "--media", "text/turtle"], resultMatch: '60040', status: 0 },

    { name: "rdf-file-frame", args: ["--rdffile", "Map/CMUMPS-FHIR/demographics.ttl", "--frame", "Map/CMUMPS-FHIR/demographics.frame"], resultMatch: '@context', status: 0 }
  ]
};
